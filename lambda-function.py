...
def lambda_handler(event, context):
    ...
    prefix_list_id = "pl-079c1c6dfb098fd9f" # Prefix List ID
    prefix_list_name = "test1" # Prefix List Name

    country_codes = ['TW']  # List of countries ['RU', 'UA', 'CN', 'KP', 'IR', 'IQ', 'TR', 'TW']
    today = "2024-04-02" # Date for which the prefixes are to be fetched test
